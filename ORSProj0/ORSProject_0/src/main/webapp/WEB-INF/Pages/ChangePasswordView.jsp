...
<meta charset="UTF-8">
<style type="text/css">
body{ background-image:url("http://localhost:8080/ORSProject_0/resources/img/bhagwa.jpg");
			...
			<aside class="col-sm-4">
				...
				<div class="card" align="center">
					<article class="card-body">
						...
						<h4 class="card-title text-center mb-4 mt-1" style="color: #fff;">
							<u><s:message code="label.changepassword"></s:message></u>
						</h4>
						<hr color="white">
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="oldPassword" /></font>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:input type="newPassword" path="newPassword"
									class="form-control" placeholder="${enternewpassword}" />


							</div>
							<div align="left">
								<font style="color: red"><sf:errors path="newPassword" /></font>
							</div>
						...
						<div class="row">
							<div class="clo-sm-6">
								<button type="submit" name="operation"
									style="width: 60px; margin-left: 15px;" value="save"
									class="btn btn-info btn-block button2 msgBtn">
									<s:message code="label.save" />
								</button>
							</div>
							<div class="clo-sm-6">
								<button type="submit" name="operation"
									style="width: 150px; margin-left: 22px;" value="My Profile"
