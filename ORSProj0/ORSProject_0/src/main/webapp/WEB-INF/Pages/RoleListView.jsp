...
<style type="text/css">
 body {
	background-image: url("http://localhost:8080/ORSProject_0/resources/img/bhagwa.jpg");
	...
	<div class="col-lg-12 col-sm-12 ml-auto mr-auto">
		<div class="card card-table" style="background-color:#f8f9fa80;">
			<h3 class="w-100 text-center under-over-line" style="color:#fff;">
				<u><s:message code="label.rolelist"></s:message></u>
			</h3>
					...
					<div class="col-lg-3">
						<div class="row">
							<div class="col-6">
								...
								name="operation"	name="operation" value="Search"><b><s:message code="label.search"></s:message></b></button>
							</div>
							<div class="col-6">
								<button type="submit"
									class="btn btn-warning btn-block btn-round w-100" name="operation"  name="operation"
									 value="Reset"><b><s:message code="label.reset"></s:message></b></button>
							</div>
						</div>
					</div>
				</div>
								...
								<tr>
									...
									<td class="text-center">
										<c:url var="editUrl" value="/ctl/Role/AddRole?id=" />
              							<a class="btn btn-outline-warning btn-block btn-round w-100" style="border-color: #8A2BE2; color: #8A2BE2;" name="operation" href="${editUrl}${role.id}"><i class="fa fa-edit" aria-hidden="true"></i></a>
									</td>
								</tr>
							</c:forEach>
							</tbody>
