...
<c:choose>
<c:when test="${form.id==0}"><h4 class="card-title text-center mb-4 mt-1" style="color: #fff;"><u><s:message code="label.addrole" /></u></h4></c:when>
<c:otherwise><h4 class="card-title text-center mb-4 mt-1" style="color: #fff;"><u><s:message code="label.updaterole"></s:message></u></h4>
</c:otherwise>
</c:choose> 
 ...
 <c:if test="${error != null}">
   ...
   <sf:hidden path="id" />
    ...
    <div align="left" style="color:#fff; " for="validationDefault02"><s:message code="label.name" />
    ...
    <div align="left" style="color:#fff; " for="validationDefault02"><s:message code="label.description" /><span style="color: red">*</span></div>
	<div class="input-group">
    <div class="input-group-prepend">
